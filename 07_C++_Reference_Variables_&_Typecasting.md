...
int main() {
    ...
    cout << "The size of 3 is " << sizeof(3) << endl; // Default -- Int ---- 4 bytes
    cout << "The size of 3.14 is " << sizeof(3.14) << endl; // Default -- Double --- 8 bytes
    cout << "The size of 3.14f is " << sizeof(3.14f) << endl; // Float ------ 4 Bytes
    cout << "The size of 3.14F is " << sizeof(3.14F) << endl; // Float ------- 4 Bytes
    cout << "The size of 3.14l is " << sizeof(3.14l) << endl; // Long Double ------- 16 Bytes
    cout << "The size of 3.14L is " << sizeof(3.14L) << endl; // Long Double ------- 16 Bytes
